    ...
    <div class="row mb-5">
              ...
              <div class="row m-sm-0">
                <div class="col-sm-12 order-1 order-sm-2">
                  <div class="owl-carousel product-slider" data-slider-id="1">
                    <a class="d-block" href="{{asset('upload/'. $product->image)}}" data-lightbox="product" title="{{$product->name}}">
            ...
            <div class="col-lg-6">
              ...
              <div class="row align-items-stretch mb-4">
                ...
                <div class="col-sm-3 pl-sm-0"><a class="btn btn-dark btn-sm btn-block h-100 d-flex align-items-center justify-content-center px-0" href="{{route('addCart',['id'=>$product->id])}}">Add to cart</a></div>
          ...
          <div class="tab-content mb-5" id="myTabContent">
            ...
            <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
              <div class="p-4 p-lg-5 bg-white">
                <div class="row">
                  <div class="col-lg-8">
                    <div class="media mb-3"><img class="rounded-circle" src="style/img/customer-1.png" alt="" width="50">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
              <div class="product text-center skel-loader">
                <div class="d-block mb-3 position-relative"><a class="d-block" href="{{route('detail', ['id'=>$related->id])}}"><img class="img-fluid w-100" src="{{asset('upload/'. $related->image)}}" alt="..."></a>
                ...
                <h6> <a class="reset-anchor" href="{{route('detail', ['id'=>$related->id])}}">{{$related->name}}</a></h6>
